...
class UserExamQuestionBacklog(BaseModel):
    ...
    medias = models.ManyToManyField(
        "lookups.Media", through="UserExamQuestionBacklogMedia"
    )
    ...
    section = models.ForeignKey(
        "exam.SectionBacklog", on_delete=models.CASCADE, null=True
    )
    subsection = models.ForeignKey(
        "exam.SubSectionBacklog", on_delete=models.CASCADE, null=True
    )

    class Meta:
        app_label = "exam"
        db_table = "exam_userexam_questionbacklog"
...
class UserExamQuestionBacklogMedia(BaseModel):
    ...
    class Meta:
        app_label = "exam"
        db_table = "exam_userexam_questionbacklog_media"
...
class UserExamQuestionBacklogChoice(BaseModel):
    ...
    medias = models.ManyToManyField(
        "lookups.Media", through="UserExamQuestionBacklogChoiceMedia"
    )

    class Meta:
        app_label = "exam"
        db_table = "exam_userexam_questionbacklog_choice"


class UserExamQuestionBacklogChoiceMedia(BaseModel):
    user_exam_question_backlog_choice = models.ForeignKey(
        UserExamQuestionBacklogChoice, on_delete=models.CASCADE
    )
    ...
    class Meta:
        app_label = "exam"
        db_table = "exam_userexam_questionbacklog_choice_media"
...
class UserExamQuestionBacklogTag(BaseModel):
    ...
    class Meta:
        app_label = "exam"
        db_table = "exam_userexam_questionbacklog_tag"
...
class UserExamQuestionBacklogRetryHint(BaseModel):
    ...
    retry_hint = models.ForeignKey(
        "questionbank.QuestionRetryHint", on_delete=models.CASCADE
    )
    text = models.TextField()
    has_media = models.BooleanField(default=False)
    ...
    medias = models.ManyToManyField(
        "lookups.Media", through="UserExamQuestionBacklogRetryHintMedia"
    )

    class Meta:
        app_label = "exam"
        db_table = "exam_userexam_questionbacklog_retryhint"


class UserExamQuestionBacklogRetryHintMedia(BaseModel):
    user_exam_question_backlog_retry_hint = models.ForeignKey(
        UserExamQuestionBacklogRetryHint, on_delete=models.CASCADE
    )
    ...
    class Meta:
        app_label = "exam"
        db_table = "exam_userexam_questionbacklog_retryhint_media"
...
class UserExamQuestionBacklogAttemptResponse(BaseModel):
    ...
    class Meta:
        app_label = "exam"
        db_table = "exam_userexam_questionbacklog_attemptresponse"
...
class SectionBacklog(BaseModel):
    ...
    subsections = models.ManyToManyField(
        "exam.SubSectionBacklog", through="SectionBacklogSubSection"
    )
    # * Section Fields
    section = models.ForeignKey("exam.Section", on_delete=models.CASCADE)
    title = models.CharField(max_length=255)
    ...
    class Meta:
        app_label = "exam"
        db_table = "exam_sectionbacklog"


class SubSectionBacklog(BaseModel):
    user_exam = models.ForeignKey("exam.UserExam", on_delete=models.CASCADE)
    # * SubSection Fields
    subsection = models.ForeignKey("exam.SubSection", on_delete=models.CASCADE)
    title = models.CharField(max_length=255)
    slug = models.SlugField(unique=True)
    sequence = models.PositiveIntegerField(default=1)
    ...
    class Meta:
        app_label = "exam"
        db_table = "exam_subsectionbacklog"
...
class SectionBacklogSubSection(BaseModel):
    ...
    class Meta:
        app_label = "exam"
        db_table = "exam_sectionbacklog_subsectionbacklog"
