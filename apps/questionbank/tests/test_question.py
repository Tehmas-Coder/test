...
class QuestionTest(QuestionUnitTest):
    ...
    reuseable_request_body = {
        ...
        "subjects": [
            {
                "difficulty_level": 1,
                "subject_education_level": {"subject": 1, "education_level": 1},
                # "countries": [],
                "is_global": 1,
                "measuring_unit": 1,
                "time_limit": 12,
            ...
            {
                "difficulty_level": 1,
                "subject_education_level": {"subject": 2, "education_level": 1},
                # "countries": [],
                "measuring_unit": 1,
                "time_limit": 10,
                "total_marks": 5,
    ...
    def successfull_creation_of_a_record_test(self):
        json_data = self.do_create_question(json.dumps(self.reuseable_request_body))
