...
class QuestionAttemptResponseUnitTest(TestSetUp):
    ...
    # ?                  UNIT - TESTS
    # ?###################################################
    def do_create_question_attempt_response(self, request_body):
        print_test_header("create_question_attempt_response")
...
class QuestionAttemptResponseTest(QuestionAttemptResponseUnitTest):
    ...
    list_of_fields_of_question_attempt_response_model = [
        "id",
        "question",
        "text",
        "type",
    ...
    # ?              TESTS - CASES
    # ?###################################################
    def test_cases_question_attempt_response(self):
        ...
        for test_dict in json_data:
            for one_value_from_list_of_fields_of_question_attempt_response_model in self.list_of_fields_of_question_attempt_response_model:
                self.assertIn(
                    ...
                    test_dict,
                    f"The key {one_value_from_list_of_fields_of_question_attempt_response_model} is not present in {test_dict}",
                )
        return json_data
    ...
    def successsfull_fetching_of_one_record_test(self, list_of_records):
        ...
        self.assertEqual(
            ...
            f"The field id ({json_data['id']} is not equal to id ({test_question_attempt_response_id}) )",
        )
        return test_question_attempt_response_id
    ...
    def successfull_deletion_of_a_record_test(self, test_record_id):
        self.do_delete_one_question_attempt_response(test_record_id)
